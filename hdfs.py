...
def hdfsDisplay(dirName,dataType) :
	...
	if dataType=='Directory':
		...
		gotoPath = "<form action='/scripts/hdfs.py'>Goto Path : <input placeholder='eg. /' name='dirName'><input type='submit' value='Go'></form>"
		newFolder = "<input type=button value='New Folder' name='newbutton' onclick=Check('newFolder','{}') />".format(dirName)		
